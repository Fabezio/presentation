...
<div class="panel">
  ...
  <div class="menu">
    <div class="thumbnail">
      <i class="icon rounded bg-blue far fa-calendar-alt fa-3x " />
    </div>
    <div class="thumbnail">
      <i class="icon rounded bg-blue far fa-bell fa-3x" />
    </div>
    <div class="thumbnail">
...
<!-- <h1>Projet</h1> -->
<footer>
  <p>dernière connexion: {formatter.format(date)}</p>
  <p class="blue bold">projet</p>
</footer>
